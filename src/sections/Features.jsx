        ...
        <section>
            <Element name='features'>
                <div className='container'>
                    <div className='relative flex flex-col border-2 border-s3 rounded-7xl md:overflow-hidden md:g7 max-md:border-none max-md:rounded-none max-md:gap-3 feature-after'>
                        <div className='relative flex md:flex-wrap flex-nowrap max-md:flex-col max-md:gap-3'>
